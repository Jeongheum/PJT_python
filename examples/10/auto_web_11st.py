...
try:
    ...
    elems = driver.find_elements_by_xpath("//ul[contains(@class, 'c_listing c_listing_view_type')]/li")
    ...
    for elem in elems:
        ...
        #price_tag = elem.find_element_by_xpath('.//div[@class="c_prd_price"]//span[@class="price"]')

        print(title_tag.text, price_tag.text)
        worksheet.append([title_tag.text, price_tag.text])

    file_name = 'C:\\Python\\examples\\10\\11st_result.xlsx'
